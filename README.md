...
Create a new GitHub Discussion with GitHub Actions
 ...
 ![](https://github.com/step-security/create-discussion/workflows/tests/badge.svg) [![code style: prettier](https://img.shields.io/badge/code_style-prettier-ff69b4.svg?style=flat-square)](https://github.com/prettier/prettier)
...
```yaml
    - name: Create a new GitHub Discussion
      ...
      uses: step-security/create-discussion@v2   
      with:
        title: Feelings
        body: |
          Let's talk!
...
This repo contains an example [workflow](https://github.com/step-security/create-discussion/blob/main/.github/workflows/example.yml) that contains this action.
